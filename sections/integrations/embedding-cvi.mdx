...
3. Design a custom video call interface using the media streams provided by the [Daily.js SDK](https://docs.daily.co/guides/customizing-in-call-ui).
</Tab>
</Tabs>
...
<AccordionGroup>
  ...
  <Accordion title="How can I reduce background noise during calls?" defaultOpen="true">
    ...
    More info: [Daily Noise Cancellation Setup](https://docs.daily.co/reference/daily-js/instance-methods/update-input-settings#audio-processor)
  </Accordion>
  ...
  <Accordion title="Can I record video calls?" defaultOpen="true">
    Yes. Tavus support video calls recording. Please see the implementation [here](/sections/conversational-video-interface/conversation/customizations/recording).
  </Accordion>
