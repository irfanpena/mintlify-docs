---
title: Tavus Researcher
description: Engage with the Tavus Researcher persona to learn more about Tavus
---

## Tavus Researcher Configuration
...
* **Persona Identity**: Named Charlie, with a friendly, playful, and technically knowledgeable character. Charlie blends emotional warmth with technical fluency, designed to make complex AI topics approachable in casual conversation.  
* ***pipeline_mode***: ***"full"***: Indicates that the full conversational pipeline is active, including vision, speech, rendering, and real-time interaction modules.  
* ***system_prompt***: A detailed directive that governs the AI’s tone, behavior, and interaction style. It instructs Charlie to be spoken-word optimized, emotionally intelligent, witty, and personable, with sci-fi references and a relaxed tone.  
* **Model Layers**:  
  * **STT Configuration**: Uses Tavus’ advanced speech-to-text engine with fine-tuned sensitivity for pauses and interruptions, supporting fluid, real-time dialogue.
