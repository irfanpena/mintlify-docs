...
* **Model Layers**:  
  ...
  * **STT Configuration**: Uses Tavus’ advanced speech-to-text engine with high sensitivity to pauses, medium sensitivity to interruptions, and smart turn detection to enable smooth, real-time conversational interaction.
