...
By using [**Raven**](/sections/models#raven%3A-perception-model), your replica becomes more context-aware, responsive, and capable of taking actions based on what it sees.
