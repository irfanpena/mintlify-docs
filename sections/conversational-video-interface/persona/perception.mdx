...
An array of custom queries that `raven-0` continuously monitors in the visual stream. These queries allow the AI to be contextually aware without explicit prompts.
<Tip>
