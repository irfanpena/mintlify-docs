...
## Raven Overview
**Raven-0** is Tavus’s advanced real-time multimodal perception model. It mimics human-like visual awareness using a dual-track vision system:
...
- **Ambient Perception**: Constant low-level visual scanning that helps Raven understand user identity, emotions, and environment.
  ...
  - Supports custom passive queries with [`ambient_awareness_queries`](#2-ambient-awareness-queries).
...
Use this field to define the custom queries `raven-0` should always monitor for.
<Tip>
