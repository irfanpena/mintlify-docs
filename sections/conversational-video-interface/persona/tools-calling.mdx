---
title: Tools Calling
sidebarTitle: Tools Calling
description: Learn how to configure the tools calling.
---

Tool calling allows AI agents to programmatically invoke functions during a conversation—enabling interaction with APIs or services in real-time.
...
| `required` | array of strings | ✅ | Specifies which parameters are mandatory for the function to execute. Each function should be included in the required list, even if they might seem optional in your code. |
